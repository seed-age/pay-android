package cc.seedland.inf.pay.widget;
...
public class RadioGroupEx extends LinearLayout {
    ...
    public RadioGroupEx(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RadioGroupEx(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public CharSequence getAccessibilityClassName() {
        return RadioGroupEx.class.getName();
    }
