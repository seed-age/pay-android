...
//        findViewById(R.id.decrypt).setOnClickListener(this);
        findViewById(R.id.main_pay_check).setOnClickListener(this);
        findViewById(R.id.main_pay_check_sandbox).setOnClickListener(this);
...
//                }
//                break;
            case R.id.main_pay_check:
                Intent iPay = new Intent(this, CartActivity.class);
                iPay.putExtra(CartActivity.EXTRA_KEY_MERCHANT, "5188611025943280");
                iPay.putExtra(CartActivity.EXTRA_KEY_SANDBOX_ON, false);
                startActivity(iPay);
                break;
